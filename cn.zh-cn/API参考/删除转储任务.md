# 删除转储任务<a name="DeleteTransferTask"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DIS&api=DeleteTransferTask)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/streams/\{stream\_name\}/transfer-tasks/\{task\_name\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>已创建的通道的名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>待删除的转储任务名称。</p>
</td>
</tr>
</tbody>
</table>
